...
public class AtbashCipherGUI extends JFrame {
    ...
    private enum Theme {
        ...
        Theme(Color background, Color textAreaBg, Color outputTextAreaBg, Color foreground, Color primaryButton, Color secondaryButton, Color border, Color menuBarBg) {
